  ...
  return (
    <article
      ...
      className="prose prose-neutral dark:prose-invert max-w-none
        ...
        [&_.katex-display]:my-6 [&_.katex-display]:overflow-x-auto [&_.katex-display]:py-2
        [&_.katex]:text-[1.1em] [&_.katex]:text-foreground
        [&_.code-block-wrapper]:relative [&_.code-block-wrapper]:my-4 [&_.code-block-wrapper]:overflow-hidden [&_.code-block-wrapper]:rounded-md [&_.code-block-wrapper]:border [&_.code-block-wrapper]:bg-background
        [&_.code-block-wrapper_pre]:!m-0 [&_.code-block-wrapper_pre]:!p-4 [&_.code-block-wrapper_pre]:!bg-transparent [&_.code-block-wrapper_pre]:!border-0
        [&_.code-block-wrapper_code]:!bg-transparent [&_.code-block-wrapper_code]:!p-0 [&_.code-block-wrapper_code]:font-mono [&_.code-block-wrapper_code]:text-sm
        [&_.code-language-label]:absolute [&_.code-language-label]:right-3 [&_.code-language-label]:top-2 [&_.code-language-label]:z-10 [&_.code-language-label]:text-xs [&_.code-language-label]:font-mono [&_.code-language-label]:text-muted-foreground/70 [&_.code-language-label]:uppercase [&_.code-language-label]:tracking-wide
