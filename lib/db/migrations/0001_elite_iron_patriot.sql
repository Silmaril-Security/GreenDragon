...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "cp_user_idx" ON "ChallengeProgress" USING btree ("userId");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "user_leaderboard_idx" ON "User" USING btree ("totalPoints","solvedCount");--> statement-breakpoint
